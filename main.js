function validate() {
    ...
    // Validation 
    if (fname.value == "") {
        document.getElementById("fnamev").innerHTML = "Fill First Name";
        notvalid = 1;
    }
    if (lname.value == "") {
        document.getElementById("lnamev").innerHTML = "Fill Last Name ";
        notvalid = 1;
    }
    if (suz.value == "") {
        document.getElementById("suzv").innerHTML = "You must give your suggestion";
        notvalid = 1;
    }
...
function clear_win() {
    if (window.matchMedia("(max-width: 500px)").matches) {
        document.getElementById("print_all").style.height = "0vh";
    }
    document.getElementById('hidden').innerHTML = '';
    document.getElementById("fnamev").innerHTML = '';
    document.getElementById("lnamev").innerHTML = '';
